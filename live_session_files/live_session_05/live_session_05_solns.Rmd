...
# Regression Models for Ordinal Categorical Response Data
...
$$
where $Odds_{x_k}(Y \le j)$ denotes the odds of observing category $j$ or smaller for $Y$. The impact of c-unit change in $x_k$ on the odds ratio is 
...
poisson.mod1 <- glm(num_awards ~ prog + math, family=poisson(link ="log"), data=df)
