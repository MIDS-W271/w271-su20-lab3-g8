...
With more than one binomial random variables, the concepts of relative risk, odds, and odds ratios become very powerful, as the meaning of the difference between probability of success, $\pi_1 - \pi_2$, is a function of the magnitude of $\pi_1$ and $\pi_2$.
