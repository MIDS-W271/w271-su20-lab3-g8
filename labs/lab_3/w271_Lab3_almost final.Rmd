...
In the fixed effects model, the coefficients for `bac8`, `bac10`,  `sbprim`, `sbsecon` and `gdl` are not significant when using heteroskedasticity robust SE. The coefficient for `perc14_24` are marginally significant at the 10% level. The rest of the coefficients are significant at the 5% level. 
